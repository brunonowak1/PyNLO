...
def geom_factors(v0_hz, v_grid_hz, *,
                      a_core_m, NA, 
                      n2_m2_per_W=2.6e-20,
    ...
    Pump handling:
      - core pumped (a_clad_m is None): overlap_p = Gamma_p_core
      - cladding pumped (a_clad_m given): overlap_p = (pi * a_core^2)/(pi * a_clad^2
    """
